...
<?php include 'include/body-top.php';?>
 <?php
    ...
    if(isset($_POST['submit']))
    {
            ...
            $SQL = "SELECT * FROM $tbl_name WHERE `IS_DELETED` = 0 AND `DESIGNATION_NAME` = '$DESIGNATION_NAME' AND `ORGANIZATION_NO` = '$ORGANIZATION_NO'";
            $COUNT = mysqli_num_rows(mysqli_query($con,$SQL));
            if($COUNT < 1):
               
               $sql = "INSERT INTO $tbl_name ( `DESIGNATION_NAME` ,`ORGANIZATION_NO` ,  `CREATED_BY` , `CREATED_ON`) VALUES(  '$DESIGNATION_NAME','$ORGANIZATION_NO', '$user_no', '$CURR_TIME')";
                $result = mysqli_query($con,$sql);
                if($result)
                {
    ...
    if(isset($_POST['update']))
    {
            ...
            $SQL = "SELECT * FROM $tbl_name WHERE `IS_DELETED` = 0 AND `DESIGNATION_NAME` = '$DESIGNATION_NAME' AND `ORGANIZATION_NO` = '$ORGANIZATION_NO' AND `DESIGNATION_NO` != '$DESIGNATION_NO'";
            $COUNT = mysqli_num_rows(mysqli_query($con,$SQL));
            if($COUNT < 1): 
                
                $sql = "UPDATE $tbl_name SET   `DESIGNATION_NAME` = '$DESIGNATION_NAME' ,`ORGANIZATION_NO` = '$ORGANIZATION_NO', `IS_UPDATED` = 1, `UPDATED_BY` = $user_no ,`UPDATED_ON` = '$CURR_TIME'  WHERE DESIGNATION_NO = $DESIGNATION_NO";
                $result = mysqli_query($con,$sql);
                if($result)
                {
...
?> 
    ...
    ?>
     ...
     <div class="form-group " <?php if($mgs=='')echo "style='display:none;'" ?>>
      ...
      <div class="form-group ">
            ...
            <div class="col-lg-5">
                <input class=" form-control" id="" name="DESIGNATION_NAME" type="text" value="<?=$result['DESIGNATION_NAME']?>" required />
            </div>
    ...
    <form class="cmxform form-horizontal " id="signupForm" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group ">
            <label for="DESIGNATION_NAME" class="control-label col-lg-3">Designation Name</label>
            <div class="col-lg-5">
                <input class=" form-control" id="" name="DESIGNATION_NAME" type="text"  required />
            </div>
